...
P3“稳定性与交互打磨”已经完成：重点修复连续晃动、组合键松手、托盘模态交互和双光标问题，并补充形状一致性、对比十字线、晃动灵敏度及全局恢复默认。P4 将在保留现有轻量定位路径的基础上增加可独立启用的局部内容放大镜。
...
右键托盘图标可以打开设置、暂停、重新加载 TOML、导出默认配置、导出诊断或退出。设置窗口支持触发方式、晃动灵敏度、高亮形状、视觉效果、全屏抑制、程序排除、恢复默认配置和当前用户登录自启动。
